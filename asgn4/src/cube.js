class Cube {
    ...
    render(color = this.color) {
        ...
        if (this.textureNum === -2) {
            ...
            // Draw front of the cube
            drawTriangle3DUVNormal(this.frontVertices, this.frontUVs, this.frontNormals, 6);
            ...
            // Draw top of the cube
            drawTriangle3DUVNormal(this.topVertices, this.topUVs, this.topNormals, 6);
            
            // Draw bottom of the cube
            drawTriangle3DUVNormal(this.bottomVertices, this.bottomUVs, this.bottomNormals, 6);
            
            // Draw left side of the cube
            drawTriangle3DUVNormal(this.leftVertices, this.leftUVs, this.leftNormals, 6);
            
            // Draw right side of the cube
            drawTriangle3DUVNormal(this.rightVertices, this.rightUVs, this.rightNormals, 6);

            // Draw back side of the cube
            drawTriangle3DUVNormal(this.backVertices, this.backUVs, this.backNormals, 6);
        } else {
